...
namespace VMC_Unit_Tests.EncryptionTests
{
    ...
    internal class EncryptionTests
    {
        ...
        public void Setup()
        {
            ...
            registryHandler = new(baseConfig);
        ...
        //    string? res = registryHandler.RegistryRead(Convert.FromBase64String("RegistryPath"));
        ...
        {
            registryHandler.RegistrySave("RegistryPath", Convert.FromBase64String(testValue));
        }
